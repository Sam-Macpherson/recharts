...
var getNodesTree = function getNodesTree(_ref, width, nodeWidth, allowFloatingTerminalNodes) {
  ...
  if (maxDepth >= 1) {
    ...
    for (var _i = 0, _len = tree.length; _i < _len; _i++) {
      var _node = tree[_i];
      if (!_node.targetNodes.length && !allowFloatingTerminalNodes) {
...
var computeData = function computeData(_ref2) {
  var data = _ref2.data,
    ...
    sort = _ref2.sort,
    allowFloatingTerminalNodes = _ref2.allowFloatingTerminalNodes;
  var links = data.links;
  var _getNodesTree = getNodesTree(data, width, nodeWidth, allowFloatingTerminalNodes),
  ...
  _createClass(Sankey, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      var data = nextProps.data,
        ...
        sort = nextProps.sort,
        allowFloatingTerminalNodes = nextProps.allowFloatingTerminalNodes;
      if (data !== prevState.prevData || width !== prevState.prevWidth || height !== prevState.prevHeight || !(0, _ShallowEqual.shallowEqual)(margin, prevState.prevMargin) || iterations !== prevState.prevIterations || nodeWidth !== prevState.prevNodeWidth || nodePadding !== prevState.prevNodePadding || sort !== prevState.sort) {
        ...
        var _computeData = computeData({
            ...
            sort: sort,
            allowFloatingTerminalNodes: allowFloatingTerminalNodes
          }),
